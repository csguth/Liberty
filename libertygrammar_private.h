...
namespace ast
{
    ...
    x3::rule<class value, boost::variant<double, int, std::string> > value = "value";
    ...
    const auto stringValue_def = (quotedString | name);
    const auto value_def = (strictDouble | int_ | stringValue);
    ...
    BOOST_SPIRIT_DEFINE(name, quotedString, stringValue, value, simpleAttribute, complexAttribute, defineStatement, attributeList, attributeStatement, groupStatement)
